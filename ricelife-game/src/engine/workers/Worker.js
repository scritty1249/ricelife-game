...
self.onmessage = async (e) => {
    ...
    try {
        ...
        if (command) {
            ...
            /* Payload expected:
             * {
             *    ammoImport: String, // file name (without extension) of module
             *    params: Array,
             ...
             * }
             */
            const { ammoImport, collisions, params, increment, limit, terrain } = payload;
            if (!AMMO_TYPES.has(ammoImport)) AMMO_TYPES.add(ammoImport);
