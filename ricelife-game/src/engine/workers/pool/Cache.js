...
Cache.TYPES.set(CanvasCache.TYPE, CanvasCache);
Cache.TYPES.set(TerrainCache.TYPE, TerrainCache);
Cache.TYPES.set(PolygonCache.TYPE, PolygonCache);
Cache.TYPES.set(ShapeCache.TYPE, ShapeCache);
